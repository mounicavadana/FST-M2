...
public void setUp() {
    ...
    requestSpec = new RequestSpecBuilder()
        ...
        .addHeader("Authorization", "token ghp_52oGp0d6a84yZGQmEgQuROh12AU4xD1wIq7")
        .setBaseUri("https://api.github.com")
        .build();
   
    sshKey = "ssh-rsa ";
}
@Test(priority=1)
  public void post() {
